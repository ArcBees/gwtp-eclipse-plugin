...
package com.gwtplatform.plugin.view;
...
public class GwtPropertyPage extends PropertyPage implements IWorkbenchPropertyPage {
  ...
  private void setValues() {
    try {
      String nameTokensValue = project.getProject().getPersistentProperty(
          new QualifiedName(Activator.PLUGIN_ID, "nametokens"));
      String ginjectorValue = project.getProject().getPersistentProperty(
          new QualifiedName(Activator.PLUGIN_ID, "ginjector"));
      String presenterModuleValue = project.getProject().getPersistentProperty(
          new QualifiedName(Activator.PLUGIN_ID, "presentermodule"));
      String handlerModuleValue = project.getProject().getPersistentProperty(
          new QualifiedName(Activator.PLUGIN_ID, "handlermodule"));
      String actionValue = project.getProject().getPersistentProperty(
          new QualifiedName(Activator.PLUGIN_ID, "action"));
  ...
  public boolean performOk() {
    try {
      project.getProject().setPersistentProperty(
          new QualifiedName(Activator.PLUGIN_ID, "nametokens"), nameTokens.getText());
      project.getProject().setPersistentProperty(
          new QualifiedName(Activator.PLUGIN_ID, "ginjector"), ginjector.getText());
      project.getProject().setPersistentProperty(
          new QualifiedName(Activator.PLUGIN_ID, "presentermodule"), presenterModule.getText());
      project.getProject().setPersistentProperty(
          new QualifiedName(Activator.PLUGIN_ID, "handlermodule"), handlerModule.getText());
  ...
  protected IType chooseTokenName() {
    ...
    FilteredTypesSelectionDialog dialog = new FilteredTypesSelectionDialog(getShell(), false, null,
        scope, IJavaSearchConstants.CLASS, new TokenNameSelectionExtension());
  ...
  protected IType chooseGinjector() {
    ...
    FilteredTypesSelectionDialog dialog = new FilteredTypesSelectionDialog(getShell(), false, null,
        scope, IJavaSearchConstants.INTERFACE, new GinjectorSelectionExtension());
  ...
  protected IType choosePresenterModule() {
    ...
    FilteredTypesSelectionDialog dialog = new FilteredTypesSelectionDialog(getShell(), false, null,
        scope, IJavaSearchConstants.CLASS, new PresenterModuleSelectionExtension());
  ...
  private IType chooseHandlerModule() {
    ...
    FilteredTypesSelectionDialog dialog = new FilteredTypesSelectionDialog(getShell(), false, null,
        scope, IJavaSearchConstants.CLASS, new HandlerModuleSelectionExtension());
  ...
  private IType chooseActionSuperclass() {
    ...
    FilteredTypesSelectionDialog dialog = new FilteredTypesSelectionDialog(getShell(), false, null,
        scope, IJavaSearchConstants.CLASS, new ActionSuperclassSelectionExtension());
    ...
    public ITypeInfoFilterExtension getFilterExtension() {
      ITypeInfoFilterExtension extension = new ITypeInfoFilterExtension() {
        ...
        public boolean select(ITypeInfoRequestor requestor) {
          try {
            IType type = project.findType(requestor.getPackageName() + "."
