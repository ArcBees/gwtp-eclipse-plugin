 ...
 *
 */
public class ActionValidator extends ProjectClass {

  public ActionValidator(IPackageFragmentRoot root, String fullyQualifiedName,
  ...
  protected IType createType() throws JavaModelException {
    // Not needed, as the second constructor is not present
    return null;
  }
